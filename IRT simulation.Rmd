...
Analyse <- function(condition, dat, fixed_objects = NULL) {
    ...
    if(assumption != "NEAT") {
      mod <- manageWarnings(mirt(data, 1, itemtype=type, SE=T, dentype="Gaussian", formula=~group, covdata=covdata), warning2error = "Could not invert information matrix; model may not be (empirically) identified.")
    } else {
